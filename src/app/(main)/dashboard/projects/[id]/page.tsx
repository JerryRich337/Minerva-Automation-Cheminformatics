...
import { 
  ...
  Play, ChevronLeft, Activity, MoreHorizontal, Beaker, Save
} from "lucide-react";
...
const KetcherEditor = dynamic(() => import("@/components/ketcher-editor"), {
  ...
  loading: () => (
    <div className="flex h-full w-full items-center justify-center bg-muted/10">
      <p className="text-sm text-muted-foreground animate-pulse">Loading Ketcher Engine...</p>
    </div>
  ),
});
...
const CORE_COMPOUND_LIBRARY: Compound[] = [
  { id: 1, name: "Imatinib", type: "Tyrosine kinase inhibitor", target: "BCR-ABL", mw: "493.6 g/mol", smiles: "CC1=C(C=C(C=C1)NC(=O)C2=CC=C(C=C2)CN3CCN(CC3)C)NC4=NC=CC(=N4)C5=CN=CC=C5" },
  { id: 2, name: "Aspirin", type: "NSAID", target: "COX-1, COX-2", mw: "180.2 g/mol", smiles: "CC(=O)OC1=CC=CC=C1C(=O)O" },
  { id: 3, name: "Metformin", type: "Biguanide", target: "AMPK", mw: "129.2 g/mol", smiles: "CN(C)C(=N)NC(=N)N" },
  { id: 4, name: "Paracetamol", type: "Analgesic", target: "COX-1, COX-2, COX-3", mw: "151.2 g/mol", smiles: "CC(=O)NC1=CC=C(O)C=C1" },
  { id: 5, name: "Ibuprofen", type: "NSAID", target: "COX-1, COX-2", mw: "206.3 g/mol", smiles: "CC(C)CC1=CC=C(C=C1)C(C)C(=O)O" },
  { id: 6, name: "Gefitinib", type: "EGFR inhibitor", target: "EGFR", mw: "446.9 g/mol", smiles: "COC1=C(OCCCN2CCOCC2)C=C2N=CN=C(NC3=CC(Cl)=C(F)C=C3)C2=C1" },
  { id: 7, name: "Erlotinib", type: "EGFR inhibitor", target: "EGFR", mw: "393.4 g/mol", smiles: "COCCOC1=C(OCCOC)C=C2N=CN=C(NC3=CC=CC=C3C#C)C2=C1" },
  { id: 8, name: "Sorafenib", type: "Multikinase inhibitor", target: "RAF, VEGFR, PDGFR", mw: "464.8 g/mol", smiles: "CNC(=O)C1=NC=CC(=C1)OC2=CC=C(NC(=O)NC3=CC(Cl)=C(C=C3)C(F)(F)F)C=C2" },
  { id: 9, name: "Dasatinib", type: "Tyrosine kinase inhibitor", target: "BCR-ABL, SRC", mw: "488.0 g/mol", smiles: "CC1=NC(NC2=NC=C(S2)C(=O)NC3=C(C=CC=C3Cl)Cl)=CC(=N1)N4CCN(CC4)CCO" },
  { id: 10, name: "Nilotinib", type: "Tyrosine kinase inhibitor", target: "BCR-ABL", mw: "529.5 g/mol", smiles: "CC1=CN=C(N=C1N)NC2=CC(=CC=C2)C(=O)NC3=CC(=C(C=C3)C(F)(F)F)N4CCN(CC4)C" },
  { id: 11, name: "Lapatinib", type: "HER2/EGFR inhibitor", target: "HER2, EGFR", mw: "581.1 g/mol", smiles: "CS(=O)(=O)CCNCC1=CC=C(O1)C2=CC3=C(C=C2)N=CN=C3NC4=CC(Cl)=C(OCC5=CC=CC=C5F)C=C4" },
  { id: 12, name: "Sunitinib", type: "RTK inhibitor", target: "VEGFR, PDGFR, KIT", mw: "398.5 g/mol", smiles: "CCN(CC)CCNC(=O)C1=C(NC2=C1C=CC=C2)C=C3C(=O)NC(=O)N3" },
  { id: 13, name: "Vemurafenib", type: "BRAF inhibitor", target: "BRAF V600E", mw: "489.9 g/mol", smiles: "CCCS(=O)(=O)NC1=C(C=C(C=C1)C2=C(C=NC=C2)C3=CC=C(C=C3)Cl)F" },
  { id: 14, name: "Crizotinib", type: "ALK/MET inhibitor", target: "ALK, ROS1, MET", mw: "450.3 g/mol", smiles: "CC(C)OC1=CC=C(C=C1)N2CCN(CC2)C3=NC4=C(N3)C=C(C=C4)Cl" },
  { id: 15, name: "Ruxolitinib", type: "JAK inhibitor", target: "JAK1, JAK2", mw: "306.4 g/mol", smiles: "C1CC(C1)N2C=C(C=N2)C3=CN=C(N=C3)N4CCN(CC4)C#N" },
  { id: 16, name: "Tofacitinib", type: "JAK inhibitor", target: "JAK1, JAK3", mw: "312.4 g/mol", smiles: "CC1CCN(C1)C2=NC=NC3=C2C=CN3C4CC4" },
  { id: 17, name: "Atorvastatin", type: "HMG-CoA reductase inhibitor", target: "HMGCR", mw: "558.6 g/mol", smiles: "CC(C)C1=C(C(=C(N1CC(CC(CC(=O)O)O)O)C2=CC=C(C=C2)F)C3=CC=CC=C3)C(=O)NC4=CC=CC=C4" },
  { id: 18, name: "Simvastatin", type: "HMG-CoA reductase inhibitor", target: "HMGCR", mw: "418.6 g/mol", smiles: "CCC(C)(C)C(=O)OC1CC(C=C2C1C(C(C=C2)C)CCC3CC(CC(=O)O3)O)C" },
  { id: 19, name: "Warfarin", type: "Anticoagulant", target: "VKORC1", mw: "308.3 g/mol", smiles: "CC(=O)CC(C1=CC=CC=C1)C2=C(O)C3=CC=CC=C3OC2=O" },
  { id: 20, name: "Caffeine", type: "Adenosine receptor antagonist", target: "ADORA1, ADORA2A", mw: "194.2 g/mol", smiles: "CN1C=NC2=C1C(=O)N(C(=O)N2C)C" },
  { id: 21, name: "Theophylline", type: "Methylxanthine", target: "PDE, adenosine receptors", mw: "180.2 g/mol", smiles: "CN1C2=C(C(=O)N(C1=O)C)NC=N2" },
  { id: 22, name: "Dopamine", type: "Catecholamine neurotransmitter", target: "Dopamine receptors", mw: "153.2 g/mol", smiles: "NCCc1ccc(O)c(O)c1" },
  { id: 23, name: "Serotonin", type: "Monoamine neurotransmitter", target: "5-HT receptors", mw: "176.2 g/mol", smiles: "NCCc1c[nH]c2ccc(O)cc12" },
  { id: 24, name: "Histamine", type: "Biogenic amine", target: "Histamine receptors", mw: "111.1 g/mol", smiles: "NCCc1c[nH]cn1" },
  { id: 25, name: "Epinephrine", type: "Adrenergic agonist", target: "Alpha/beta adrenergic receptors", mw: "183.2 g/mol", smiles: "CNC[C@H](O)c1ccc(O)c(O)c1" },
  { id: 26, name: "Acetylcholine", type: "Neurotransmitter", target: "Muscarinic/nicotinic receptors", mw: "146.2 g/mol", smiles: "CC(=O)OCC[N+](C)(C)C" },
  { id: 27, name: "GABA", type: "Inhibitory neurotransmitter", target: "GABA receptors", mw: "103.1 g/mol", smiles: "NCCCC(=O)O" },
  { id: 28, name: "Glutamate", type: "Amino acid neurotransmitter", target: "NMDA, AMPA, mGluR", mw: "147.1 g/mol", smiles: "NC(CCC(=O)O)C(=O)O" },
  { id: 29, name: "Leucine", type: "Essential amino acid", target: "mTOR nutrient signaling", mw: "131.2 g/mol", smiles: "CC(C)CC(N)C(=O)O" },
  { id: 30, name: "Tryptophan", type: "Essential amino acid", target: "Serotonin biosynthesis", mw: "204.2 g/mol", smiles: "N[C@@H](CC1=CNC2=CC=CC=C12)C(=O)O" },
  { id: 31, name: "NAD+", type: "Redox cofactor", target: "Dehydrogenases, PARP, sirtuins", mw: "663.4 g/mol", smiles: "NC(=O)c1ccc[n+](c1)[C@@H]2O[C@H](COP(=O)(O)OP(=O)(O)OC[C@H]3O[C@@H](n4cnc5c(N)ncnc45)[C@H](O)[C@@H]3O)[C@H](O)[C@@H]2O" },
  { id: 32, name: "ATP", type: "Nucleotide triphosphate", target: "Kinases, ATPases", mw: "507.2 g/mol", smiles: "Nc1ncnc2n(cnc12)[C@@H]3O[C@H](COP(=O)(O)OP(=O)(O)OP(=O)(O)O)[C@@H](O)[C@H]3O" },
  { id: 33, name: "Folic Acid", type: "Vitamin/cofactor", target: "One-carbon metabolism", mw: "441.4 g/mol", smiles: "NC1=NC(=O)NC(=N1)NC2=CC=C(C=C2)C(=O)N[C@@H](CCC(=O)O)C(=O)O" },
  { id: 34, name: "Methotrexate", type: "Antifolate", target: "DHFR", mw: "454.4 g/mol", smiles: "CN(CC1=CN=C2N=C(N)N=C(N)C2=N1)C3=CC=C(C=C3)C(=O)N[C@@H](CCC(=O)O)C(=O)O" },
  { id: 35, name: "Penicillin G", type: "Beta-lactam antibiotic", target: "PBPs", mw: "334.4 g/mol", smiles: "CC1(C)S[C@@H]2[C@H](NC(=O)Cc3ccccc3)C(=O)N2[C@H]1C(=O)O" },
  { id: 36, name: "Ciprofloxacin", type: "Fluoroquinolone antibiotic", target: "DNA gyrase, Topo IV", mw: "331.3 g/mol", smiles: "C1CC1N2C=C(C(=O)C3=CC(F)=C(N4CCNCC4)C=C32)C(=O)O" },
  { id: 37, name: "Doxycycline", type: "Tetracycline antibiotic", target: "30S ribosome", mw: "444.4 g/mol", smiles: "C[C@H]1[C@H]2C[C@H]3C(=C(O)C4=C(C(=O)C(=C(O)C4=O)C(=O)N)C3=O)C(=O)[C@@]2(O)C(=C1O)O" },
  { id: 38, name: "Ritonavir", type: "Protease inhibitor", target: "HIV protease, CYP3A", mw: "720.9 g/mol", smiles: "CC(C)C[C@H](NC(=O)[C@H](CC1=CC=CC=C1)NC(=O)OC(C)(C)C)C(=O)N[C@@H](CC2=CC=CC=C2)C[C@H](O)[C@H](CC3=CC=CC=C3)NC(=O)C4=NC=CS4" },
  { id: 39, name: "Remdesivir", type: "Nucleotide analog prodrug", target: "Viral RNA polymerase", mw: "602.6 g/mol", smiles: "CCC(CC)OC(=O)N[P@@](=O)(OC[C@H]1O[C@@](C#N)(C2=CC=C3N=CN=C(N)C3=N2)[C@H](O)[C@@H]1O)OC4=CC=CC=C4" },
  { id: 40, name: "Oseltamivir", type: "Neuraminidase inhibitor", target: "Influenza neuraminidase", mw: "312.4 g/mol", smiles: "CCOC(=O)C1=C[C@@H](OC(CC)CC)[C@H](N)C[C@H]1NC(C)=O" },
  { id: 41, name: "Acyclovir", type: "Nucleoside analog antiviral", target: "Viral DNA polymerase", mw: "225.2 g/mol", smiles: "NC1=NC(=O)N(C=N1)COCCO" },
  { id: 42, name: "Dexamethasone", type: "Glucocorticoid", target: "Glucocorticoid receptor", mw: "392.5 g/mol", smiles: "C[C@@H]1C[C@H]2[C@@H]3CCC4=CC(=O)C=C[C@]4(C)[C@H]3C[C@H](O)[C@@]2(F)[C@@]1(O)C(=O)CO" },
  { id: 43, name: "Estradiol", type: "Steroid hormone", target: "Estrogen receptors", mw: "272.4 g/mol", smiles: "CC12CCC3C(C1CCC2O)CCC4=C3C=CC(=C4)O" },
  { id: 44, name: "Testosterone", type: "Steroid hormone", target: "Androgen receptor", mw: "288.4 g/mol", smiles: "CC12CCC3C(C1CCC2O)CCC4=CC(=O)CCC34C" },
  { id: 45, name: "Curcumin", type: "Natural product polyphenol", target: "NF-kB, antioxidant pathways", mw: "368.4 g/mol", smiles: "COC1=C(C=CC(=C1)C=CC(=O)CC(=O)C=CC2=CC(=C(C=C2)O)OC)O" },
];
...
export default function ProjectWorkspacePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const filteredCompounds = COMPOUND_LIBRARY.filter((compound) => 
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          if (data.savedStructures) {
            const uniqueSavedStructures = data.savedStructures.filter((structure, index, structures) => (
  ...
  const getStructureStats = (smiles: string) => {
    ...
    const countAtom = (symbol: string) => atomTokens.filter((token) => token.toLowerCase() === symbol.toLowerCase()).length;
    ...
    const inferredHydrogens = Math.max(0, (2 * cCount) + 2 + nCount - xCount - (2 * (rings + doubleBonds + (2 * tripleBonds) + (aromaticRings * 3))));

    const getElem = (sym: string, count: number) => count > 1 ? `${sym}${count}` : count === 1 ? sym : "";
    const formula = `${getElem("C", cCount)}${getElem("H", inferredHydrogens)}${getElem("N", nCount)}${getElem("O", oCount)}${getElem("S", sCount)}${getElem("P", pCount)}${getElem("F", fCount)}${getElem("Cl", clCount)}${getElem("Br", brCount)}${getElem("I", iCount)}` || "Unknown";
    const molecularWeight = (cCount * 12.011) + (inferredHydrogens * 1.008) + (nCount * 14.007) + (oCount * 15.999) + (sCount * 32.06) + (pCount * 30.974) + (fCount * 18.998) + (clCount * 35.45) + (brCount * 79.904) + (iCount * 126.904);
    const calculatedLogP = ((cCount * 0.32) + (aromaticRings * 0.35) + (xCount * 0.28) - (oCount * 0.45) - (nCount * 0.32) - (sCount * 0.18)).toFixed(2);
    const calculatedTPSA = ((oCount * 12.0) + (nCount * 23.0) + (sCount * 25.0) + (pCount * 30.0)).toFixed(1);
    const hydrogenDonors = Math.max(0, Math.min(nCount + oCount, (smiles.match(/\[nH\]|N|O/g) || []).length)).toString();
    const hydrogenAcceptors = Math.max(0, nCount + oCount + Math.floor(sCount / 2)).toString();
    const rotatableBonds = Math.max(0, (smiles.match(/-/g) || []).length + Math.floor((atomTokens.length - rings) / 8)).toString();
    const solubilityMgMl = Math.pow(10, 0.5 - (0.75 * parseFloat(calculatedLogP)) - (0.006 * molecularWeight)) * molecularWeight / 1000;
    const solubility = solubilityMgMl < 0.01 ? `${(solubilityMgMl * 1000).toFixed(2)} ug/mL` : `${solubilityMgMl.toFixed(2)} mg/mL`;
    const toxScore = Math.min(0.98, Math.max(0.04, 0.12 + (xCount * 0.07) + (parseFloat(calculatedLogP) > 5 ? 0.18 : 0) + (molecularWeight > 650 ? 0.12 : 0))).toFixed(2);
    ...
    return {
      ...
      dlStatus: drugLikenessScore >= 8 ? "Excellent Candidate" : drugLikenessScore >= 5 ? "Good Candidate" : "Poor Candidate",
  ...
  const handleLoadStructure = async (structure: Pick<SavedStructure, "id" | "mw" | "smiles" | "molfile">, name: string) => {
    ...
    try {
      ...
      if (!currentSmiles || currentSmiles.trim() === "") {
        if (predictionAction !== "Variant Ranking Engine") {
          setViewMode("prediction"); 
          setPredictions({
            name: "Empty Canvas", formula: "", mw: "0.0 g/mol", logp: "0.0", tpsa: "0.0 Å²", rotatableBonds: "0", hydrogenDonors: "0", hydrogenAcceptors: "0", ringCount: "0", aromaticRings: "0", heavyAtoms: "0", formalCharge: "0", fCsp3: "0.00", complexity: "0", solubility: "0.0 mg/mL", predictionText: "No structural data provided.", confidence: "0%", toxScore: "0.00", riskLevel: "N/A", drugLikenessScore: "0 / 10", lipinskiViolations: "N/A", dlStatus: "N/A", smiles: ""
          });
        }
        setCalculating(false);
        return; 
      ...
      const xCount = (currentSmiles.match(/[Ff]/g) || []).length + (currentSmiles.match(/Cl/gi) || []).length + (currentSmiles.match(/Br/gi) || []).length + (currentSmiles.match(/[Ii]/g) || []).length;
      ...
      const estimatedMW = (cCount * 12.011) + (oCount * 15.999) + (nCount * 14.007) + (xCount * 19.00); 
      ...
      const solubilityMgMl = Math.pow(10, baseSolubilityLog) * parseFloat(calculatedTotalMW) / 1000;
      const finalSolubilityStr = solubilityMgMl < 0.01 ? `${(solubilityMgMl * 1000).toFixed(2)} µg/mL` : `${solubilityMgMl.toFixed(2)} mg/mL`;
      ...
      const rawDLScore = 10 - ((parseFloat(calculatedLogP) > 5 ? 2.5 : 0) + (parseFloat(calculatedTotalMW) > 500 ? 2.5 : 0));
      ...
      const newPredictionObj = {
        name: isModified ? `${selectedCompound?.name || "Target"} Variant` : (selectedCompound?.name || "Target Compound"),
        formula: formulaStr,
        mw: `${calculatedTotalMW} g/mol`,
        logp: calculatedLogP,
        tpsa: `${calculatedTPSA} Å²`,
        rotatableBonds: "0", hydrogenDonors: "0", hydrogenAcceptors: "0", ringCount: rings.toString(), aromaticRings: aromaticRings.toString(), heavyAtoms: "0", formalCharge: "0", fCsp3: "0.00", complexity: "0", 
        solubility: finalSolubilityStr, 
        predictionText: "Profile generated.", confidence: "90%", 
        toxScore: finalToxScore, 
        riskLevel: parseFloat(finalToxScore) > 0.4 ? "High Risk" : "Low Risk" as "Low Risk" | "Medium Risk" | "High Risk" | "N/A", 
      ...
      if (predictionAction !== "Variant Ranking Engine") {
        ...
        setVariantList((prev) => {
          ...
          if (!isDuplicate) {
            ...
            return [...prev, { ...evaluatedPredictionObj, name: selectedCompound.name }];
          }
          return prev;
        });
      }
    ...
    <div className="space-y-6 flex flex-col h-full">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex shrink-0 flex-col gap-2 sm:flex-row sm:items-center">
          {!isSearching ? (
            <Button variant="secondary" className="gap-2 cursor-pointer w-full sm:w-auto" onClick={() => setIsSearching(true)}>
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <div className="relative w-full sm:w-64">
                ...
                <Input autoFocus placeholder="Search compounds or targets..." className="pl-9" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
              </div>
          ...
          viewMode === "canvas" ? (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col rounded-xl border bg-card shadow-sm overflow-hidden h-[500px]">
                <div className="flex items-center justify-between border-b bg-muted/30 px-4 py-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Button variant="outline" size="sm" className="gap-2 cursor-pointer text-red-500 hover:bg-red-50 hover:text-red-600 border-red-200 transition-colors" onClick={handleRemoveCompound}>
              ...
              <div className="relative flex justify-end gap-2">
                ...
                >
                  {predictionAction === "Variant Ranking Engine" ? <Plus className="size-4" /> : <Play className="size-4 fill-current" />}
                  {predictionAction === "Variant Ranking Engine" ? "Add Variant to Queue" : predictionAction}
                </Button>
                
                <div className="relative">
                  <Button variant="outline" size="icon" className="h-11 w-11 cursor-pointer" onClick={() => setIsMenuOpen(!isMenuOpen)} onBlur={() => setTimeout(() => setIsMenuOpen(false), 200)}>
                  ...
                  {isMenuOpen && (
                    <div className="absolute right-0 bottom-full mb-2 w-56 rounded-md border bg-card text-card-foreground shadow-lg z-50 overflow-hidden flex flex-col py-1 animate-in fade-in zoom-in-95">
                      {["Run Prediction", "Solubility Prediction", "Toxicity Prediction", "Drug-Likeness Score", "Variant Ranking Engine"].map((action) => (
                        <button
                          key={action}
            ...
            <div className="rounded-xl border bg-card p-6 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-center justify-between border-b pb-4">
                <div className="flex items-center gap-2">
                  <Activity className={`size-5 ${predictionAction === 'Variant Ranking Engine' ? 'text-indigo-500' : 'text-primary'} animate-pulse`} />
                  <h2 className="text-xl font-bold tracking-tight">
                    {predictionAction === "Run Prediction" ? "Property Profile" : 
                    predictionAction === "Variant Ranking Engine" ? "Variant Ranking Results" :
              ...
              {calculating ? (
                ...
                <div className="space-y-6">
                  ...
                  {predictionAction !== "Variant Ranking Engine" && (
                    <div>
                      <span className="text-xs uppercase font-semibold tracking-wider text-muted-foreground">Evaluated System Model</span>
                  ...
                  {predictionAction === "Variant Ranking Engine" ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {variantList.map((variant, idx) => {
                        ...
                        return (
                          <div key={idx} className="flex flex-col rounded-xl border bg-card shadow-sm overflow-hidden transition-all hover:shadow-md hover:border-indigo-200">
                            <div className="p-5 border-b bg-muted/20">
                              ...
                              <p className="text-sm font-medium text-muted-foreground mt-1 truncate" title={variant.name}>
                                {variant.name}
                              </p>
                            </div>
                            
                            <div className="p-5 flex-1 space-y-4">
                              <p className={`text-[15px] font-medium flex items-center gap-2 ${isSoluble ? 'text-emerald-600 dark:text-emerald-500' : 'text-amber-600'}`}>
                                {isSoluble ? '✓ High Solubility' : '⚠️ Mod/Low Solubility'}
                              </p>
                              <p className={`text-[15px] font-medium flex items-center gap-2 ${isLowTox ? 'text-emerald-600 dark:text-emerald-500' : 'text-red-500'}`}>
                                {isLowTox ? '✓ Low Toxicity' : '⚠️ Elevated Toxicity Alert'}
                              </p>
                              <p className={`text-[15px] font-medium flex items-center gap-2 ${isHighDL ? 'text-emerald-600 dark:text-emerald-500' : 'text-amber-600'}`}>
                                {isHighDL ? '✓ Drug-Likeness ≥ 8.0' : '⚠️ Drug-Likeness < 8.0'}
                              </p>
                            </div>

                            <div className="p-5 bg-indigo-50/50 dark:bg-indigo-950/20 border-t">
                              <span className="text-xs uppercase font-bold tracking-wider text-muted-foreground block mb-1">Overall Assessment:</span>
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="rounded-xl border bg-card p-4 shadow-xs flex flex-col justify-between">
                          <div>
                            ...
                            <div className="flex items-baseline justify-between mt-1">
                              ...
                              >
                                <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["solubility_mw"] ? "-rotate-90" : "rotate-180"}`} />
                              </button>
                            </div>
                          </div>
                          {unfoldedEquations["solubility_mw"] && (
                            <div className="mt-3 p-3 rounded-lg bg-muted/50 border border-border/50 text-xs text-muted-foreground space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                              ...
                              <div className="overflow-x-auto py-1.5 px-2 font-mono text-center text-foreground bg-background rounded border border-border/30">MW = (C × 12.01) + (H × 1.01) + (N × 14.01) + (O × 16.00) + (X × 19.00)</div>
                              <p className="text-[11px] leading-relaxed">Summation of basic atomic mass values based on character string scanning counts. Halogens (X) default weight mapped to Fluorine equivalent baselines.</p>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="rounded-xl border bg-blue-500/5 border-blue-200/30 p-4 shadow-xs flex flex-col justify-between">
                          <div>
                            <span className="text-xs font-medium text-blue-600 dark:text-blue-400 block">Solubility (In H2O)</span>
                            <div className="flex items-baseline justify-between mt-1">
                              <p className="text-2xl font-bold font-mono text-blue-600 dark:text-blue-400">{predictions?.solubility}</p>
                              <button
                                ...
                                title="Toggle Equation Breakdown"
                              >
                                <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["solubility_val"] ? "-rotate-90" : "rotate-180"}`} />
                              </button>
                            </div>
                          </div>
                          {unfoldedEquations["solubility_val"] && (
                            <div className="mt-3 p-3 rounded-lg bg-blue-500/10 border border-blue-200/50 text-xs text-blue-900 dark:text-blue-200 space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                              ...
                              <div className="overflow-x-auto py-1.5 px-2 font-mono text-center bg-background/50 rounded border border-blue-200/30">LogS = 0.5 - 0.01(MW) - 0.5(LogP) - 0.1(RotBonds)</div>
                              <p className="text-[11px] leading-relaxed">General Solubility Equation (GSE) estimating aqueous solubility based on molecular weight, lipophilicity, and molecular flexibility.</p>
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                      ...
                      <div className="rounded-xl border bg-card p-4 shadow-xs flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-baseline justify-between mt-1">
                            ...
                            <button
                              ...
                              className="p-1 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors cursor-pointer"
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["toxScore"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        {unfoldedEquations["toxScore"] && (
                          <div className="mt-3 p-3 rounded-lg bg-muted/50 border border-border/50 text-xs text-muted-foreground space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <div className="overflow-x-auto py-1.5 px-2 font-mono text-center text-foreground bg-background rounded border border-border/30">ToxScore = Base(0.15) + (Halogens × 0.15) + LogP Penalty</div>
                            <p className="text-[11px] leading-relaxed">Calculated risk coefficient factoring in highly reactive substituents and excess lipophilicity.</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="rounded-xl border bg-red-500/5 border-red-200/30 p-4 shadow-xs flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-baseline justify-between mt-1">
                            <p className="text-2xl font-bold text-red-600 dark:text-red-400">{predictions?.riskLevel}</p>
                            <button
                            ...
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["riskLevel"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        {unfoldedEquations["riskLevel"] && (
                          <div className="mt-3 p-3 rounded-lg bg-red-500/10 border border-red-200/50 text-xs text-red-900 dark:text-red-200 space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <div className="overflow-x-auto py-1.5 px-2 font-mono text-center bg-background/50 rounded border border-red-200/30">Risk Level = Count(Toxicophores ∩ SMILES) == 0</div>
                            <p className="text-[11px] leading-relaxed">Substructure matching against a predefined library of mutagenic, reactive functional groups, and PAINS alerts.</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="rounded-xl border bg-card p-4 shadow-xs flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-baseline justify-between mt-1">
                            <p className="text-2xl font-bold font-mono text-card-foreground">{predictions?.confidence}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                      ...
                      <div className="rounded-xl border bg-card p-4 shadow-xs flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-baseline justify-between mt-1">
                            <p className="text-2xl font-bold font-mono text-card-foreground">{predictions?.drugLikenessScore}</p>
                            <button
                              onClick={() => toggleEquation("dlScore")}
                              className="p-1 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors cursor-pointer"
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["dlScore"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        {unfoldedEquations["dlScore"] && (
                          <div className="mt-3 p-3 rounded-lg bg-muted/50 border border-border/50 text-xs text-muted-foreground space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <div className="overflow-x-auto py-1.5 px-2 font-mono text-center text-foreground bg-background rounded border border-border/30">QED = exp( (1/n) × Σ ln(d_i) )</div>
                            <p className="text-[11px] leading-relaxed">Geometric mean of individual desirability functions (d_i) for molecular properties including MW, LogP, PSA, H-bond donors/acceptors, and rotatable bonds.</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="rounded-xl border bg-emerald-500/5 border-emerald-200/30 p-4 shadow-xs flex flex-col justify-between">
                        <div>
                          <span className="text-xs font-medium text-emerald-600 dark:text-emerald-400 block">Candidate Status</span>
                          <div className="flex items-baseline justify-between mt-1">
                            <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{predictions?.dlStatus}</p>
                            <button
                            ...
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["dlStatus"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        {unfoldedEquations["dlStatus"] && (
                          <div className="mt-3 p-3 rounded-lg bg-emerald-500/10 border border-emerald-200/50 text-xs text-emerald-900 dark:text-emerald-200 space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <div className="overflow-x-auto py-1.5 px-2 font-mono text-center bg-background/50 rounded border border-emerald-200/30">Status = (QED ≥ 5.0) & (Violations ≤ 1) & (Risk != "High")</div>
                            <p className="text-[11px] leading-relaxed">Boolean logic gate evaluating composite scores across structural desirability, physicochemical properties, and toxicological parameters to determine final viability.</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="rounded-xl border bg-card p-4 shadow-xs flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-baseline justify-between mt-1">
                            <p className="text-2xl font-bold font-mono text-card-foreground">{predictions?.lipinskiViolations}</p>
                            <button
                              onClick={() => toggleEquation("lipinski")}
                              className="p-1 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors cursor-pointer"
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["lipinski"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        {unfoldedEquations["lipinski"] && (
                          <div className="mt-3 p-3 rounded-lg bg-muted/50 border border-border/50 text-xs text-muted-foreground space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <div className="overflow-x-auto py-1.5 px-2 font-mono text-center text-foreground bg-background rounded border border-border/30">Violations = (MW&gt;500) + (LogP&gt;5) + (HBD&gt;5) + (HBA&gt;10)</div>
                            <p className="text-[11px] leading-relaxed">Evaluates drug-likeness based on four primary pharmacokinetic rules. A count of 2 or more typically indicates potential issues with poor oral absorption.</p>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                        ...
                        <div>
                          ...
                          <div className="flex items-baseline justify-between mt-1">
                            ...
                            <button
                              ...
                              title="Toggle Equation Breakdown"
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["mw"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        ...
                        {unfoldedEquations["mw"] && (
                          <div className="mt-3 p-3 rounded-lg bg-muted/50 border border-border/50 text-xs text-muted-foreground space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <p className="text-[11px] leading-relaxed">
                              Summation of basic atomic mass values based on character string scanning counts. Halogens (X) default weight mapped to Fluorine equivalent baselines.
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="rounded-xl border bg-card p-4 text-card-foreground shadow-xs flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-baseline justify-between mt-1">
                            ...
                            <button
                              ...
                              title="Toggle Equation Breakdown"
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["logp"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        ...
                        {unfoldedEquations["logp"] && (
                          <div className="mt-3 p-3 rounded-lg bg-muted/50 border border-border/50 text-xs text-muted-foreground space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <p className="text-[11px] leading-relaxed">
                              Approximated using a simplified empirical fragmentation model. Carbon contributions increase lipophilicity, while electronegative heteroatoms lower it.
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="rounded-xl border bg-card p-4 text-card-foreground shadow-xs flex flex-col justify-between">
                        <div>
                          <span className="text-xs font-medium text-muted-foreground block">TPSA (Polar Surface Area)</span>
                          <div className="flex items-baseline justify-between mt-1">
                            <p className="text-2xl font-bold font-mono tracking-tight text-card-foreground">
                            ...
                            <button
                              ...
                              title="Toggle Equation Breakdown"
                            >
                              <ChevronLeft className={`size-4 transition-transform duration-200 ${unfoldedEquations["tpsa"] ? "-rotate-90" : "rotate-180"}`} />
                            </button>
                          </div>
                        </div>
                        ...
                        {unfoldedEquations["tpsa"] && (
                          <div className="mt-3 p-3 rounded-lg bg-muted/50 border border-border/50 text-xs text-muted-foreground space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                            ...
                            <p className="text-[11px] leading-relaxed">
                              Calculated based on the standard fallback surface properties mapped across localized oxygen and nitrogen coordinate counts.
                            </p>
                          </div>
                        )}
                      </div>
          ...
          <div className="overflow-y-auto p-4">
            <div className="grid gap-2">
              {filteredCompounds.map((compound) => (
                <div key={compound.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-lg border p-4 hover:bg-muted/40 cursor-pointer group">
                  <div>
                    <h4 className="font-semibold text-base">{compound.name}</h4>
                    <p className="text-sm text-muted-foreground mt-1">{compound.type} • Target: {compound.target}</p>
                  </div>
                  <Button variant="secondary" size="sm" className="opacity-0 group-hover:opacity-100 cursor-pointer" onClick={() => handleAddCompound(compound)}>
